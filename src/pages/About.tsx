      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            ...
            transportation, our Ride Management System is reshaping how cities
            move.
          </p>
        </div>
      </section>
        ...
        <div className="container grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6 text-muted-foreground">
              We launched in 20XX after noticing a gap in the market for a truly
              integrated, user-centric ride service. Our goal wasn't just to
              connect riders and drivers, but to create a sustainable ecosystem
              built on **transparency and safety**. We started with a small
              fleet and have since grown into a robust, scalable platform
              supporting thousands of daily trips.
            </p>
            <p className="leading-7 [&:not(:first-child)]:mt-4 text-muted-foreground">
              Our technology is proprietary, leveraging real-time data and AI to
              optimize routes, ensuring the fastest, most efficient service for
              riders and maximum earnings for our drivers.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6 mt-6">
              ...
              <Card className="p-4 border-l-4 border-green-500">
                ...
                <p className="text-sm text-muted-foreground">
                  Ensuring our service is easily available and affordably priced
                  for everyone in the communities we serve.
                </p>
              </Card>
              <Card className="p-4 border-l-4 border-blue-500">
                ...
                <p className="text-sm text-muted-foreground">
                  Providing flexible earning models and comprehensive support to
                  empower our driver partners.
                </p>
              </Card>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Focuses on rider acquisition and brand communication strategies.
              </p>
            </div>
          </div>
