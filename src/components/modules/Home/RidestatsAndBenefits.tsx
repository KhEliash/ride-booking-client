...
const RidestatsAndBenefits = () => {
  return (
    <section className="w-full  py-16 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-10 text-muted-foreground">
        sdf
      </div>
      ...
      <div className="  relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-6xl">
          ...
          <div className="flex flex-col items-center p-6 bg-muted rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
